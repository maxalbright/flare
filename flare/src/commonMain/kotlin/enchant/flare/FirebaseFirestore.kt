...
/**settings uselss, transactions and batches not, 
dont document metdata, mapdocument, list collection up to changes; 
changes are special values you can set on a document using the same codeblock syntax as collection
 */
